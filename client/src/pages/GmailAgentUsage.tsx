...
export default function GmailAgentUsage() {
  ...
  const fetchEmails = async () => {
    ...
    try {
      ...
      // 🆕 Raw response'u logla ve ekranda göster
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg sm:text-2xl font-normal text-[var(--dark-purple)]">
                  {t("gmail.title")}
                </h1>
  ...
  <div className="flex flex-col gap-6 sm:gap-4 sm:flex-col xl:flex-row xl:items-center">
    
{/* Sol taraf - Butonlar */}
<div className="flex flex-wrap items-center gap-3 w-full">
  {/* Get Emails */}
  <div className="flex-1 min-w-[140px] sm:flex-none sm:w-auto">
    <HighlightButton
      onClick={fetchEmails}
      disabled={!accessToken || dailyUsage >= dailyLimit}
      className="w-full sm:w-auto px-4 py-2"
    >
      <span className="text-sm font-medium flex items-center justify-center sm:justify-start">
  ...
  <div className="flex-1 min-w-[140px] sm:flex-none sm:w-auto">
    <button
      ...
      className="w-full sm:w-auto px-4 py-2 rounded-lg text-sm text-gray-700 dark:text-white border border-gray-300 dark:border-gray-600 transition-all duration-200"
    >
  ...
  <div className="w-full sm:w-auto">
    <button
      ...
      className="text-red-600 dark:text-red-400 border border-red-600 dark:border-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 px-4 py-2 rounded-lg text-sm w-full sm:w-auto"
    >
      <span className="flex items-center justify-center sm:justify-start">
...
<div className="flex flex-row items-center justify-between w-full gap-4 flex-wrap">
  ...
  {/* Remaining Count */}
  <div className="flex flex-col items-end justify-center text-right flex-shrink-0 min-w-[60px]">
...
{!loading && emails.length === 0 && accessToken && (
  <div className="text-center mt-16 mb-16">
    ...
    <h3 className="text-xl font-normal text-[var(--dark-purple)] mb-2">
      {t("gmail.noEmails")}
    </h3>
