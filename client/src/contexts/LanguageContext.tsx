...
const translations = {
  tr: {
    ...
    "home.game.description": "Fareyi hareket ettirin ve mıknatısın çekici gücünü hissedin!",
  ...
  en: {
    ...
    "home.game.description": "Move the mouse and feel the magnetic attraction!",
